...
uint16_t conf = ADS1015_REG_CONFIG_CQUE_NONE    | // Disable the comparator (default val)
...
uint8_t m_conversionDelay = ADS1015_CONVERSIONDELAY;
...
void loop() {
  ...
  writeRegister(ADS1015_ADDRESS,ADS1015_REG_POINTER_CONFIG, conf);
  ...
  Serial.print("ADC0: ");
  Serial.println( readRegister(ADS1015_ADDRESS, ADS1015_REG_POINTER_CONVERT) >> m_bitShift ) ;  
